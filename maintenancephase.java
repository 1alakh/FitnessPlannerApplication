...
public class maintenancephase extends JFrame implements ActionListener
{
...
public maintenancephase(int age, double heightFeet ,double heightInches,String gender, double currentWeight, double n ,double minutes)
{
...
if(n==0||n==1 || n==2 || n==3){
	...
	l5=new JLabel("Protein(in gm's)");
        ...
        l8=new JLabel("MAINTENANCE PHASE");
...
t4.setText(String.valueOf(String.format("%.2f",calorie)));
...
fxPanel.setBounds(10,10,500,500);
...
public static void main(String args[])
    {
       maintenancephase obj=new maintenancephase();
    }
